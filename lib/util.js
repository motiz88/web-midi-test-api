...
function validateMidiMessage(data) {
  ...
  switch (data[0] & 0xf0) {
    ...
    case 0xf0:
      ...
      return data.length >= 1 && Array.prototype.slice.call(data).every(function (x) {
...
module.exports = { convertMIDIMessageToString: convertMIDIMessageToString, dec2hex: dec2hex, defaults: defaults, validateMidiMessage: validateMidiMessage, makeChannelName: makeChannelName };